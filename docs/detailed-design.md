...
- 版: 1.2（2026-08-03 更新。レビュー指摘の運用モード/PII方針を確定）
- 対象: `docs/requirements.md` 版 1.8 / `docs/non-functional-requirements.md` 版 1.3 /
  `docs/design.md` 版 1.4
...
| 段階 | 実装 | 完了条件 |
|---|---|---|
| 0 | 2章の確定 / デプロイ疎通 / `/health` の骨組み | 本番 URL で空の Laravel と `/health` が応答 |
